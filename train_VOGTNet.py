...
testsample_dir = '../VOGTNet-results/test-samples-v{}/'.format(version)  # 保存测试阶段G生成的图片
evalsample_dir = '../VOGTNet-results/eval-samples-v{}/'.format(version)
record_dir = '../VOGTNet-results/record-v{}/'.format(version)  # 保存训练阶段的损失值
model_dir = '../VOGTNet-results/models-v{}/'.format(version)
...
checkpoint1 = torch.load(checkpoint_model2)
down_spe.load_state_dict(checkpoint1['down_spe'], strict=False)
